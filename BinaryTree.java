...
public class BinaryTree<E> {
	...
	public BinaryTree copyToDepth(int d){
		...
		BinaryTree<E> leftSub = null;
		BinaryTree<E> rightSub = null;
		if(hasLeft()){
				leftSub = left.copyToDepth(d-1);
		}
		if(hasRight()){
			rightSub = right.copyToDepth(d-1);
		}
		return new BinaryTree<E>(data,leftSub,rightSub);
	}
...
//
//		System.out.println("tournament.copyToDepth(1)");
//		System.out.println(tournament.copyToDepth(2));
//
////		// Tree of life
